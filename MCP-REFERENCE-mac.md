# MCP-REFERENCE-mac.md - V4.0 macOS Terminal Edition
...
- 🔧 **Cursor IDE Support**: Full integration with Cursor IDE (installed and working on macOS)
...
| **6. Use good tools** | Cursor IDE, Codex CLI (confirmed working on macOS) |
